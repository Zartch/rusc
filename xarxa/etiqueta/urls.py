...
from xarxa.etiqueta import views


urlpatterns = patterns('',
        url(r'^modetiqueta/(?P<pk>\d+)/$', views.etiquetaUpdateView.as_view() ,name='mod_etiqueta'),
        url(r'^deletiqueta/(?P<pk>\d+)/$', views.etiquetaDeleteView.as_view() ,name='delete_etiqueta'),
        ...
        url(r'^nova/$', login_required(views.EtiquetaCreateView.as_view()) ,name='etiqueta_nova'),
