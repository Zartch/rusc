...
from xarxa.usuari.forms import userProfileGeneralForm, userProfileForm
from cela.models import get_cela
from xarxa.post.models import Post, Vote
from xarxa.etiqueta.models import Etiqueta
from xarxa.usuari.forms import userInfoForm
...
class UserProfileUpdateView(UpdateView):
    ...
    def form_valid(self, form):
        from xarxa.usuari.models import UserInfo
